...
AppRegistry.registerModule({applicationId:'marketplace.reakai.rekai-webapp|1.6.5',path:'/main',module:function(define){'use strict';define(function (require) {
  'use strict';
